...
$block_class = "col-xs-12 col-sm-4";
if (isset($arParams["NEWS_LINE_COUNT"]) && (int)$arParams["NEWS_LINE_COUNT"] > 0) {
    $block_class = "col-xs-12 col-sm-".(round(12/$arParams["NEWS_LINE_COUNT"]));
}
...
<div class="tile-wrap">
    <div class="row">
        <?foreach($arResult["ITEMS"] as $arItem):
            ...
            ?>
            <div class="<?=$block_class;?>" id="<?=$this->GetEditAreaId($arItem['ID']);?>">
                <div class="tile-block">
                    <?if($arParams["DISPLAY_PICTURE"]!="N"):?>
                        <?if ($arItem["VIDEO"]):?>
                            <div class="video-wrap bx-newslist-youtube embed-responsive embed-responsive-16by9">
                                <iframe
                        ...
                        <?elseif ($arItem["SOUND_CLOUD"]):?>
                            <div class="audio-wrap bx-newslist-audio">
                                <iframe
                                    width="100%"
                                    height="166"
                                    scrolling="no"
                        ...
                        <?elseif ($arItem["SLIDER"] && count($arItem["SLIDER"]) > 1):?>
                            <div class="slider-wrap bx-newslist-slider">
                        ...
                        <?elseif ($arItem["SLIDER"]):?>
                            <div class="image-wrap bx-newslist-img">
                    ...
                    <?if($arParams["DISPLAY_NAME"]!="N" && $arItem["NAME"]):?>
                        <? if (isset($arItem["SECTION_NAME"]) && !empty($arItem["SECTION_NAME"])): ?>
                            <div class="section-title">
                                <a href="<?echo $arItem["SECTION_LINK"]?>"><?echo $arItem["SECTION_NAME"]?></a>
                            </div>
                        <? endif; ?>
                        <div class="title bx-newslist-title">
                            <?if(!$arParams["HIDE_LINK_WHEN_NO_DETAIL"] || ($arItem["DETAIL_TEXT"] && $arResult["USER_HAVE_ACCESS"])):?>
                    ...
                    <?if($arParams["DISPLAY_PREVIEW_TEXT"]!="N" && $arItem["PREVIEW_TEXT"]):?>
                        <div class="description bx-newslist-content">
