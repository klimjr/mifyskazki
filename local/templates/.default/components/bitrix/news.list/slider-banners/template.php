...
<ul class="bx-slider">
    <?foreach($arResult["ITEMS"] as $arItem):
        ...
        ?>
        <li class="bx-newslist-container" id="<?=$this->GetEditAreaId($arItem['ID']);?>">
            <div class="slider-banner-item bx-newslist-block">
                <?if($arParams["DISPLAY_PICTURE"]!="N"):?>
                    <?if ($arItem["VIDEO"]):?>
                        <div class="video-wrap bx-newslist-youtube embed-responsive embed-responsive-16by9" style="display: block;">
                            <iframe
                ...
                <div class="description-wrap">
                    ...
                    <?if($arParams["DISPLAY_PREVIEW_TEXT"]!="N" && $arItem["PREVIEW_TEXT"]):?>
                        <div class="text bx-newslist-content">
